...
if ($username && $userpass){
    ...
    {
        $failure = 1;
        $_SESSION['warning'] = "<b>login.php:</b><br>Could not find a user with this account: " . $username . ", try again or <a href='index.php?p=register'>register</a> with your own email!";
    }
}
else
{
